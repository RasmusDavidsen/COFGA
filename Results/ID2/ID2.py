...
results_name = "ResNet50_5degRot_aug__map.csv"
results_name_AP_val = "ResNet50_5degRot_aug__AP_val.csv"
results_name_AP_train = "ResNet50_5degRot_aug_AP_train.csv"
...
COFGA_headers = pd.read_csv('/zhome/b0/8/88043/COFGA_Project/dataset/train_preprocessed.csv')
...
#train_indices, val_indices = indices[:40], indices[40:45]
...
class COFGA_NET(nn.Module):
    def __init__(self):
        ...
        self.l_out = nn.Linear(1024, NUM_CLASSES)
...
for epoch in range(num_epoch):  # loop over the dataset multiple times
    ...
    if int(epoch+1) % int(1) == 0 or int(epoch)==int(num_epoch) or int(epoch) == 0:
